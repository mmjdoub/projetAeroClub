...
CREATE TRIGGER TRIG_ETAPRES_INS
...
CREATE TRIGGER TRIG_ETAPRES_DEL
ON TABLE ETAT_PILOTE_PRESENCE 
FOR DELETE
AS UPDATE ETAT_PILOTE_PRESENCE 
   SET DATMAJ = DATE()
...
CREATE TRIGGER TRIG_ETASAN_INS
...
CREATE TRIGGER TRIG_ETASAN_DEL
ON TABLE ETAT_PILOTE_SANTE 
FOR DELETE
AS UPDATE ETAT_PILOTE_SANTE 
   SET DATMAJ = DATE()
...
CREATE TRIGGER TRIG_ETASIT_DEL
ON TABLE ETAT_PILOTE_SITUATION
FOR DELETE
AS UPDATE ETAT_PILOTE_SITUATION 
   SET DATMAJ = DATE()
...
(
   ...
   ADRESSE              integer                        FOREIGN KEY REFERENCES ADRESSE(ADRESSEID),
...
CREATE TRIGGER TRIG_PILOTAGE_INS
ON TABLE PILOTAGE  
FOR INSERT
AS UPDATE PILOTAGE 
   SET DATCRE = DATE()
...
CREATE TRIGGER TRIG_PILOTAGE_DEL
ON TABLE PILOTAGE 
FOR DELETE
AS UPDATE PILOTAGE  
   SET DATMAJ = DATE()
