...
AVIONS.
	...
	MOVE "O" TO WS-ETATAV.
	EXEC SQL
	UPDATE AVIONS SET ETATAV := WS-ETAT-AVION, CPTINTER:=0
	...
	IF SQLCODE=0
		...
		-" Résultat du dernier contrôle" WS-RESCONTROL " Compteur interne : " WS-CPTINTER        
	END-IF.
...
PILOTES.
	...
	EXEC SQL
		UPDATE PILOTES SET ETAT_PILOTE_SANTE:="M" FROM PILOTES, ETAT_PILOTE_PRESENCE, VISITES
