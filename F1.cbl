...
**** ECRAN DE SAISIE
  ...
  01  SCREEN-ACCUEIL.
	...
	01 SCREEN-DEPOT-PLAN.
      ...
      05 LINE 04 COL 01 VALUE "DEPOT D'UN PLAN DE VOL".
      05 LINE 05 COL 01 VALUE "******************".
	  05 LINE 07 COL 01 VALUE "Plan de vol déposé avec succès !".
	  05 LINE 09 COL 01 VALUE "    Numéro de vol : ".
	  05 LINE 09 COL 22 PIC 9(3) FROM WS-NUMVOL.
	  05 LINE 10 COL 01 VALUE "    Date de départ : "
	  05 LINE 10 COL 22 PIC X(10) FROM DATE-DEPART.
	  05 LINE 11 COL 01 VALUE "    Date d'arrivée : "
	  05 LINE 11 COL 22 PIC X(10) FROM DATE-ARRIVEE.
	  05 LINE 12 COL 01 VALUE "    Destination : ".
	  05 LINE 12 COL 22 PIC X(25) FROM DEST.
	  05 LINE 13 COL 01 VALUE "    Avion numéro : ".
	  05 LINE 13 COL 22 PIC 9(3) FROM WS-NUMAV.
	  02 LINE 14 COL 01 VALUE "    Pilote :".
	  02 LINE 14 COL 22 PIC X(20) FROM WS-NOM.
	  05 LINE 19 COL 01 VALUE "******************".
      05 LINE 20 COL 01 PIC X(43) FROM ERREURS.
	  05 LINE 20 COL 45 PIC Z FROM NB-ESSAI.
      05 LINE 21 COL 01 VALUE "REVENIR AU MENU (M) OU QUITTER (Q) :".
...
******AJOUT DU VOL DANS LA BDD		
	...
	DISPLAY DELETE-SCREEN.
	ACCEPT WDATE FROM DATE.
    DISPLAY SCREEN-DEPOT-PLAN.
    ACCEPT SCREEN-DEPOT-PLAN.
