...
ENREGISTREMENT.
	...
	EXEC SQL
		UPDATE VOLS SET DATEDEB=:WS-DATEDEB, DATEFIN=:WS-DATEFIN, 
		CPTDEP=:WS-CPTDEP, CPTARR=:WS-CPTARR, DESTIN=:WS-DESTIN,
		ETATVOL=:WS-ETATVOL
