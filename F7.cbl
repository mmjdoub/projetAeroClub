...
SCREEN SECTION.
  ...
  01  SCREEN-ACCUEIL.
      ...
      05 LINE 03 COL 30 VALUE "FACTURATION DES VOLS".
      05 LINE 04 COL 25 VALUE "Periode du ".
	  05 LINE 04 COL 36 PIC Z(6) TO PERIOD1.
	  05 LINE 04 COL 43 VALUE "au ".
	  05 LINE 04 COL 46 PIC Z(6) TO PERIOD2.
	  05 LINE 05 COL 13 VALUE "N. avion ".
	  05 LINE 05 COL 60 VALUE "Tarif".
	  05 LINE 07 COL 07 VALUE " Dates        |".
	  05 LINE 08 COL 24 VALUE "Destination  |".
	  05 LINE 08 COL 01 VALUE "--------------------|".
	  05 LINE 07 COL 37 VALUE "|  Compteurs hor. |".
	  05 LINE 07 COL 67 VALUE "|".
	  05 LINE 08 COL 57 VALUE "Nb h. vol |".
	  05 LINE 08 COL 69 VALUE "Cout vol".
	  05 LINE 08 COL 38 VALUE "-----------------|".
	  05 LINE 09 COL 02 VALUE "Depart  |".
	  05 LINE 09 COL 12 VALUE " Arrivee |".
	  05 LINE 09 COL 37 VALUE "| Depart |". 
	  05 LINE 09 COL 48 VALUE "Arrivee|".
	  05 LINE 09 COL 67 VALUE "|".
	  05 LINE 16 COL 51 VALUE "Total vols avion".
  ...
  01  SCREEN-FACTURE.
      ...
      05 LINE 03 COL 30 VALUE "FACTURATION DES VOLS".
      05 LINE 04 COL 25 VALUE "Periode du ".
	  05 LINE 04 COL 36 PIC Z(6) FROM PERIOD1.
	  05 LINE 04 COL 43 VALUE "au ".
	  05 LINE 04 COL 46 PIC Z(6) FROM PERIOD2.
	  05 LINE 05 COL 13 VALUE "N. avion ".
	  ...
	  05 LINE 10 COL 10 PIC X(10) FROM WS-DATEFIN.
	  05 LINE 10 COL 22 PIC X(25) FROM WS-DESTIN.
	  05 LINE 10 COL 38 PIC Z(6) FROM WS-CPTDEP.
	  05 LINE 10 COL 48 PIC Z(6) FROM WS-CPTARR.
	  05 LINE 10 COL 59 PIC Z(6) FROM WS-NBHVOL.
	  05 LINE 10 COL 69 PIC Z(4)VZZ FROM WS-COUTVOL.
	  05 LINE 16 COL 51 VALUE "Total vols avion".
	  05 LINE 16 COL 68 PIC Z(6)VZZ FROM WS-TOTALVOLAV.
	  05 LINE 19 COL 01 VALUE "******************".
	  05 LINE 20 COL 01 PIC X(50) FROM ERREURS.
	  05 LINE 20 COL 42 PIC Z FROM NB-ESSAI.
      05 LINE 21 COL 01 VALUE "REVENIR AU MENU (M) OU QUITTER (Q) :".
